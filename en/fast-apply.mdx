...
<CardGroup cols={2}>
  ...
  <Card title="Review changes" icon="code-compare" href="/en/review-changes">
    See how merged edits surface as diffs you can approve before they hit your repo.
  </Card>
  <Card title="Configure tools" icon="screwdriver-wrench" href="/en/tools">
    Manage Fast Apply behavior and optional providers from the Tools area.
  </Card>
  <Card title="How orchestration works" icon="sitemap" href="/en/orchestration">
