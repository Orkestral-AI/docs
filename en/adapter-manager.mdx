...
The usual division of labor is simple: premium adapters (Claude, Codex) PLAN, and the Forge EXECUTES the code changes locally through the deterministic Fast Apply engine. You can read more in [Forge and Fast Apply](/en/forge-fast-apply) and [Choosing models](/en/choosing-models).
...
<CardGroup cols={2}>
  <Card title="Forge and Fast Apply" icon="bolt" href="/en/forge-fast-apply">
    Learn how the local executor applies code changes at zero cost.
  </Card>
  <Card title="Choosing models" icon="brain" href="/en/choosing-models">
    Decide which adapter plans and which one executes.
  </Card>
  <Card title="Hiring your team" icon="users" href="/en/hiring-team">
    Assign specialists and the adapters they run on.
  </Card>
  <Card title="Connecting sources" icon="folder-tree" href="/en/connecting-sources">
