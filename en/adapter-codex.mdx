...
<Info>
The internal adapter type is `codex_local` and it appears as **Codex** in the onboarding grid. See [Adapters overview](/en/adapters) for how providers and the Forge fit together.
</Info>
