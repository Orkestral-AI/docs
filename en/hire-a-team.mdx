...
<CardGroup cols={2}>
  <Card title="Delegate your first issue" icon="list-check" href="/en/delegation">
    Hand work to the team and watch the CEO route it to the right specialist.
  </Card>
  <Card title="Connect more sources" icon="folder-tree" href="/en/connect-a-repository">
    Add repositories so specialists get matched to the right code.
  </Card>
  <Card title="Understand the Forge" icon="hammer" href="/en/forge">
    See how the local model executes code changes at zero API cost.
  </Card>
  <Card title="Tune adapters and models" icon="sliders" href="/en/agent-adapters">
