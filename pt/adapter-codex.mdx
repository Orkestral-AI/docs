...
<Info>
O tipo interno do adapter é `codex_local` e ele aparece como **Codex** na grade de onboarding. Veja [Visão geral dos adapters](/pt/adapters) para entender como os provedores e o Forge se encaixam.
</Info>
