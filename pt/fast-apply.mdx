...
<CardGroup cols={2}>
  ...
  <Card title="Revisar mudanças" icon="code-compare" href="/pt/code-review">
    Veja como as edições fundidas aparecem como diffs que você pode aprovar antes de chegarem ao seu repositório.
  </Card>
  <Card title="Configurar ferramentas" icon="screwdriver-wrench" href="/pt/connect-an-mcp-server">
    Gerencie o comportamento do Fast Apply e provedores opcionais na área de Ferramentas.
  </Card>
  <Card title="Como funciona a orquestração" icon="sitemap" href="/pt/delegation">
